...
#if defined(CUSTOM_PLAYBACK_LATENCY_MSEC)
#define PLAYBACK_LATENCY_MSEC (CUSTOM_PLAYBACK_LATENCY_MSEC)
#else
#define PLAYBACK_LATENCY_MSEC (400)
#endif
#define PLAYBACK_LATENCY_FRAME_NUM     (PLAYBACK_LATENCY_MSEC/INCOMING_FRAME_MSEC)  /* 20*20 = 400 ms*/
...
#if defined(CUSTOM_RECORD_LATENCY_MSEC)
#define RECORD_LATENCY_MSEC (CUSTOM_RECORD_LATENCY_MSEC)
#else
#define RECORD_LATENCY_MSEC (180)
#endif
#define RECORD_LATENCY_FRAME_NUM     (RECORD_LATENCY_MSEC/RECORD_MSEC_PER_FRAME)
